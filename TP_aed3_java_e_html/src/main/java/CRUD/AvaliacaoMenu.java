...
import main.java.CRUD.dao.ReviewDAO;
import main.java.CRUD.model.Review;
import main.java.CRUD.sort.ExternalSortReview;
...
public class AvaliacaoMenu {
    ...
    public static void menuAvaliacao(Scanner sc) throws Exception {
        ...
        do {
            ...
            System.out.println("4 - Listar avaliações por filme");
            System.out.println("5 - Listar avaliações por usuário");
    ...
    private static void ordenarAvaliacoes() {
        try {
            ...
            System.out.println("Arquivo gerado: data/review_ordenado.bin");
