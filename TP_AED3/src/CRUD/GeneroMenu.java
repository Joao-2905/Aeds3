...
public class GeneroMenu {
	...
	public static void opGenero(GenreDAO genreDao, Scanner sc) throws Exception {
	    int op;
	    do {
	        System.out.println("\n=== MENU GÊNERO ===");
	...
	private static void buscarGenero(GenreDAO genreDao, Scanner sc) throws IOException {
	    ...
	    if (g == null) System.out.println("Gênero não encontrado.");
	    else mostrarGenero(g);
	}
	...
	private static void listarGenero(GenreDAO genreDao) throws IOException { genreDao.listAll(); }
	...
	private static void atualizarGenero(GenreDAO genreDao, Scanner sc) throws IOException {
	    ...
	    String nome = sc.nextLine();
	    if (!nome.isEmpty()) g.setName(nome);

	    boolean ok = genreDao.update(g);
	    if (ok) System.out.println("Gênero atualizado!");
	...
	private static void excluirGenero(GenreDAO genreDao, Scanner sc) throws IOException {
	    ...
	    if (genreDao.delete(id)) System.out.println("Gênero excluído.");
	    else System.out.println("Gênero não encontrado.");
	}
}
