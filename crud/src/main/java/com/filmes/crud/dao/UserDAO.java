...
public class UserDAO {
   ...
   private void limparArquivosHash() {
    ...
    private void garantirAdminPadrao() throws IOException {
        ...
        if (totalAdmins <= 0) {
            User admin = new User("admin","admin@admin.com","123",true);
    ...
    public int create(User user) throws IOException {
        ...
        int recordSize = 1 + 4 + 2 + usernameSize + 2 + emailSize + 2 + passwordSize + 1;
    ...
    public void listAll() throws IOException {
        ...
        while (raf.getFilePointer() < raf.length()) {
            ...
            System.out.println(id + " | " + username + " | " + email + " | " + password + " | admin: " + administrador);
    ...
    public void validarIndice() throws IOException {
        ...
        for (int i = 0; i < indice.getDiretorio().size(); i++) {
            ...
            for (IndexEntry entry : bucket.getEntradas()) {
                ...
                if (!active) {
                    System.out.println(" Registro deletado ainda presente no índice! ID: " + id);
                    continue;
                }
