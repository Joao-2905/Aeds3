...
public class FilmGenreDAO {
    ...
    public List<FilmGenre> readByFilmID(int filmID) throws IOException {
        ...
        while (raf.getFilePointer() < raf.length()) {
            ...
            boolean active = raf.readBoolean();
            int id = raf.readInt();
            int filmIDRegistro = raf.readInt();
            int genreID = raf.readInt();

            if (active && filmIDRegistro == filmID) {
                lista.add(new FilmGenre(id, filmIDRegistro, genreID));
            }
    ...
    public List<FilmGenre> readByGenreID(int genreID) throws IOException {
        ...
        while (raf.getFilePointer() < raf.length()) {
            ...
            int id = raf.readInt();
            int filmID = raf.readInt();
            int genreIDRegistro = raf.readInt();

            if (active && genreIDRegistro == genreID) {
                lista.add(new FilmGenre(id, filmID, genreIDRegistro));
            }
