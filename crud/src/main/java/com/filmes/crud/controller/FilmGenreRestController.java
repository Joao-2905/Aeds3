...
public class FilmGenreRestController {
    ...
    public Object listar() {
        try {
            ...
            return new ErrorResponse(mensagemOuPadrao(e,"Erro ao listar relações filme-gênero."));
        }
    }
    ...
    public Object buscar(@PathVariable int id) {
        try {
            ...
            if (fg == null) {
                return new ErrorResponse( "Relação filme-gênero não encontrada.");
            }

            return fg;

        } catch (Exception e) {
            return new ErrorResponse(mensagemOuPadrao(e,"Erro ao buscar relação filme-gênero."));
        }
    }
    ...
    public Object listarPorFilme(@PathVariable int filmID) {
        try {
            ...
            return new ErrorResponse(mensagemOuPadrao(e, "Erro ao listar gêneros do filme."));
        }
    }
    ...
    public Object listarPorGenero(@PathVariable int genreID) {
        try {
            ...
            return new ErrorResponse(mensagemOuPadrao(e,"Erro ao listar filmes do gênero."));
        }
    }
    ...
    public Object listarIdsFilmesDoGenero(@PathVariable int genreID) {
        try {
            ...
            return new ErrorResponse(mensagemOuPadrao(e,"Erro ao listar IDs dos filmes do gênero."));
        }
    }
    ...
    public Object buscarPorFilmeEGenero(@PathVariable int filmID, @PathVariable int genreID) {
        try {
            FilmGenre fg = filmGenreService.findByFilmAndGenre(filmID, genreID);
    ...
    public Object criar(@RequestBody FilmGenre fg) {
        try {
            ...
            return new ErrorResponse(mensagemOuPadrao(e,"Erro ao criar relação filme-gênero."));
        }
    }
    ...
    public Object criarMultiplos(@RequestBody Map<String, Object> body) {
        ...
        try {
            ...
            if (filmIDObj == null || genreIDsObj == null) {
                return new ErrorResponse("filmID e genreIDs são obrigatórios.");
            }
            ...
            return new ErrorResponse(mensagemOuPadrao(e,"Erro ao criar múltiplas relações."));
        }
    }
    ...
    @PutMapping("/{id}")
    public Object atualizar(@PathVariable int id,@RequestBody FilmGenre fg) {
        try {
            fg.setID(id);
            ...
            return new ErrorResponse(mensagemOuPadrao(e,"Erro ao atualizar relação filme-gênero."));
        }
    }
    ...
    public Object substituirGenerosDoFilme(
        ...
        try {
            ...
            if (genreIDsObj == null) {
                return new ErrorResponse("genreIDs é obrigatório.");
            }
            ...
            boolean ok = filmGenreService.replaceGenresOfFilm(filmID,genreIDs);

            if (ok) {
                return new SuccessResponse("Gêneros do filme atualizados com sucesso.");
            }

            return new ErrorResponse("Erro ao atualizar gêneros do filme.");

        } catch (Exception e) {
            return new ErrorResponse(mensagemOuPadrao(e,"Erro ao atualizar gêneros do filme."));
        }
    }
    ...
    public Object deletar(@PathVariable int id) {
        try {
            ...
            if (ok) {
                return new SuccessResponse("Relação filme-gênero deletada com sucesso.");
            }

            return new ErrorResponse("Relação filme-gênero não encontrada.");

        } catch (Exception e) {
            return new ErrorResponse(mensagemOuPadrao(e,"Erro ao deletar relação filme-gênero."));
        }
    }
    ...
    public Object deletarPorFilme(@PathVariable int filmID) {
        try {
            ...
            if (ok) {
                return new SuccessResponse("Relações do filme deletadas com sucesso.");
            }

            return new ErrorResponse("Nenhuma relação encontrada para este filme.");

        } catch (Exception e) {
            return new ErrorResponse(mensagemOuPadrao(e,"Erro ao deletar relações do filme."));
        }
    }
    ...
    public Object deletarPorGenero(@PathVariable int genreID) {
        try {
            ...
            if (ok) {
                return new SuccessResponse("Relações do gênero deletadas com sucesso.");
            }

            return new ErrorResponse("Nenhuma relação encontrada para este gênero.");

        } catch (Exception e) {
            return new ErrorResponse(mensagemOuPadrao(e,"Erro ao deletar relações do gênero."));
        }
    }

    @DeleteMapping("/filme/{filmID}/genero/{genreID}")
    public Object deletarPorFilmeEGenero(@PathVariable int filmID, @PathVariable int genreID) {

        try {
            boolean ok = filmGenreService.deleteByFilmAndGenre(filmID,genreID);
    ...
    public Object buscarIdsPorFilme(@PathVariable int filmID) {
        try {
            ...
            return new ErrorResponse(mensagemOuPadrao(e,"Erro ao buscar IDs das relações por filme."));
        }
    }
    ...
    public Object buscarIdsPorGenero(@PathVariable int genreID) {
        try {
            ...
            return new ErrorResponse(mensagemOuPadrao(e,"Erro ao buscar IDs das relações por gênero."));
        }
    }
