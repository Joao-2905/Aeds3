...
public class GenreController {
    ...
    public ResponseEntity<?> buscar(@PathVariable int id) {
        try {
            ...
            if (genre == null) {
                return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ErrorResponse("Gênero não encontrado."));
            }

            return ResponseEntity.ok(genre);

        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorResponse(mensagemOuPadrao(e, "Erro ao buscar gênero.")));
        }
    }
    ...
    public ResponseEntity<?> criar(@RequestBody Genre genre) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorResponse(mensagemOuPadrao(e, "Erro ao cadastrar gênero.")));
        }
    }
    ...
    public ResponseEntity<?> atualizar(@PathVariable int id, @RequestBody Genre genre) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorResponse(mensagemOuPadrao(e, "Erro ao atualizar gênero.")));
        }
    }
    ...
    public ResponseEntity<?> excluir(@PathVariable int id) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorResponse(mensagemOuPadrao(e, "Erro ao excluir gênero.")));
        }
    }
    ...
    public ResponseEntity<?> listarFilmesDoGenero(@PathVariable int id) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorResponse(mensagemOuPadrao(e, "Erro ao listar filmes do gênero.")));
        }
    }
    ...
    public ResponseEntity<?> listarIdsRelacoesDoGenero(@PathVariable int id) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorResponse(mensagemOuPadrao(e, "Erro ao listar IDs das relações do gênero.")));
        }
    }
    ...
    public ResponseEntity<?> removerFilmesDoGenero(@PathVariable int id) {
        try {
            ...
            if (!ok) {
                return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ErrorResponse("Nenhuma relação encontrada para este gênero."));
            }

            return ResponseEntity.ok(new SuccessResponse("Relações do gênero removidas com sucesso."));

        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorResponse(mensagemOuPadrao(e, "Erro ao remover relações do gênero.")));
        }
    }
