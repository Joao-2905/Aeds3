...
public class ReviewRestController {
    ...
    public Object listarExternalSortCrescente() {
        try {
            ...
            return new ErrorResponse(mensagemOuPadrao(e, "Erro na ordenação externa crescente."));
        }
    }
    ...
    public Object listarExternalSortDecrescente() {
        try {
            ...
            return new ErrorResponse(mensagemOuPadrao(e, "Erro na ordenação externa decrescente."));
        }
    }
}